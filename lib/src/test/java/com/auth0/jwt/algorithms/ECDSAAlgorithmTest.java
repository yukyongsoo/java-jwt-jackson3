...
public class ECDSAAlgorithmTest {
    ...
    @Test
    public void shouldThrowOnECDSA256VerificationWithDERSignature() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: SHA256withECDSA"));
        assertThat(exception.getCause(), isA(SignatureException.class));
        assertThat(exception.getCause().getMessage(), is("Invalid JOSE signature format."));
    }
    ...
    public void shouldFailECDSA256VerificationWhenProvidedPublicKeyIsNull() {
        ...
        assertThat(exception.getCause().getMessage(), (is("The given Public Key is null.")));
    }

    @Test
    public void shouldFailECDSA256VerificationWithInvalidPublicKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA256VerificationWhenUsingPrivateKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJFUzI1NiJ9.eyJpc3MiOiJhdXRoMCJ9.W9qfN1b80B9hnMo49WL8THrOsf1vEjOhapeFemPMGySzxTcgfyudS5esgeBTO908X5SLdAr5jMwPUPBs9b6nNg";
    ...
    @Test
    public void shouldFailECDSA256VerificationOnInvalidJOSESignatureLength() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA256VerificationOnInvalidJOSESignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA256VerificationOnInvalidDERSignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldThrowOnECDSA384VerificationWithDERSignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: SHA384withECDSA"));
        assertThat(exception.getCause(), isA(SignatureException.class));
        assertThat(exception.getCause().getMessage(), (is("Invalid JOSE signature format.")));
    }
    ...
    @Test
    public void shouldThrowOnECDSA384VerificationWithDERSignatureWithBothKeys() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA384VerificationWithInvalidPublicKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA384VerificationWhenUsingPrivateKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJFUzM4NCJ9.eyJpc3MiOiJhdXRoMCJ9._k5h1KyO-NE0R2_HAw0-XEc0bGT5atv29SxHhOGC9JDqUHeUdptfCK_ljQ01nLVt2OQWT2SwGs-TuyHDFmhPmPGFZ9wboxvq_ieopmYqhQilNAu-WF-frioiRz9733fU";
    ...
    @Test
    public void shouldFailECDSA384VerificationOnInvalidJOSESignatureLength() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA384VerificationOnInvalidJOSESignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldThrowOnECDSA512VerificationWithDERSignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: SHA512withECDSA"));
        assertThat(exception.getCause(), isA(SignatureException.class));
        assertThat(exception.getCause().getMessage(), (is("Invalid JOSE signature format.")));
    }
    ...
    @Test
    public void shouldThrowECDSA512VerificationWithDERSignatureWithBothKeys() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA512VerificationWithInvalidPublicKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA512VerificationWhenUsingPrivateKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJFUzUxMiJ9.eyJpc3MiOiJhdXRoMCJ9.AZgdopFFsN0amCSs2kOucXdpylD31DEm5ChK1PG0_gq5Mf47MrvVph8zHSVuvcrXzcE1U3VxeCg89mYW1H33Y-8iAF0QFkdfTUQIWKNObH543WNMYYssv3OtOj0znPv8atDbaF8DMYAtcT1qdmaSJRhx-egRE9HGZkinPh9CfLLLt58X";
    ...
    @Test
    public void shouldFailECDSA512VerificationOnInvalidJOSESignatureLength() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA512VerificationOnInvalidJOSESignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailECDSA512VerificationOnInvalidDERSignature() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldFailJOSEToDERConversionOnInvalidJOSESignatureLength() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    public void shouldThrowOnVerifyWhenSignatureAlgorithmDoesNotExists() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: some-alg"));
        assertThat(exception.getCause(), isA(NoSuchAlgorithmException.class));
    }

    @Test
    public void shouldThrowOnVerifyWhenThePublicKeyIsInvalid() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: some-alg"));
        assertThat(exception.getCause(), isA(InvalidKeyException.class));
    }
    ...
    public void shouldFailOnECDSA256SigningWhenProvidedPrivateKeyIsNull() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: SHA256withECDSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Private Key is null.")));
    }

    @Test
    public void shouldFailOnECDSA256SigningWhenUsingPublicKey() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    public void shouldFailOnECDSA384SigningWhenProvidedPrivateKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: SHA384withECDSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Private Key is null.")));
    }

    @Test
    public void shouldFailOnECDSA384SigningWhenUsingPublicKey() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    public void shouldFailOnECDSA512SigningWhenProvidedPrivateKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: SHA512withECDSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Private Key is null.")));
    }

    @Test
    public void shouldFailOnECDSA512SigningWhenUsingPublicKey() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    @Test
    public void shouldThrowOnSignWhenSignatureAlgorithmDoesNotExists() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: some-algorithm"));
        assertThat(exception.getCause(), isA(NoSuchAlgorithmException.class));
    }

    @Test
    public void shouldThrowOnSignWhenThePrivateKeyIsInvalid() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    @Test
    public void shouldThrowOnSignWhenTheSignatureIsNotPrepared() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    @Test
    public void shouldThrowOnDERSignatureConversionIfDoesNotStartWithCorrectSequenceByte() {
        Throwable exception = assertThrows(SignatureException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("Invalid DER signature format."));
    }

    @Test
    public void shouldThrowOnDERSignatureConversionIfDoesNotHaveExpectedLength() throws IOException {
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) Algorithm.ECDSA256((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC"));
    ...
    @Test
    public void shouldThrowOnDERSignatureConversionIfRNumberDoesNotHaveExpectedLength() throws IOException {
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) Algorithm.ECDSA256((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC"));
        byte[] derSignature = createDERSignature(32, false, false);
    ...
    @Test
    public void shouldThrowOnDERSignatureConversionIfSNumberDoesNotHaveExpectedLength() throws IOException {
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) Algorithm.ECDSA256((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC"));
        byte[] derSignature = createDERSignature(32, false, false);
    ...
    @Test
    public void shouldThrowOnJOSESignatureConversionIfDoesNotHaveExpectedLength() throws IOException {
        ECPublicKey publicKey = (ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC");
        ...
        assertThat(exception.getMessage(), containsString("Invalid JOSE signature format."));
    }
    ...
    @Test
    public void invalidECDSA256SignatureShouldFailTokenVerification() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void emptyECDSA256SignatureShouldFailTokenVerification() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void signatureWithAllZerosShouldFail() {
        Throwable exception = assertThrows(SignatureException.class, () -> {
        ...
        assertThat(exception.getMessage(), containsString("Invalid signature format."));
    }

    @Test
    public void signatureWithRZeroShouldFail() {
        Throwable exception = assertThrows(SignatureException.class, () -> {
    ...
    @Test
    public void signatureWithSZeroShouldFail() {
        Throwable exception = assertThrows(SignatureException.class, () -> {
    ...
    @Test
    public void signatureWithRValueNotLessThanOrderShouldFail() {
        Throwable exception = assertThrows(SignatureException.class, () -> {
    ...
    @Test
    public void signatureWithSValueNotLessThanOrderShouldFail() {
        Throwable exception = assertThrows(SignatureException.class, () -> {

...
public class HMACAlgorithmTest {
    ...
    public void shouldFailHMAC256VerificationWithInvalidSecretString() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: HmacSHA256"));
    }
    ...
    public void shouldFailHMAC384VerificationWithInvalidSecretString() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: HmacSHA384"));
    }
    ...
    public void shouldFailHMAC512VerificationWithInvalidSecretString() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: HmacSHA512"));
    }
    ...
    @Test
    public void shouldThrowOnVerifyWhenTheSecretIsInvalid() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldThrowOnSignWhenTheSecretIsInvalid() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {

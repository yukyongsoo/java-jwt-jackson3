...
public class RSAAlgorithmTest {
    ...
    public void shouldFailRSA256VerificationWhenProvidedPublicKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: SHA256withRSA"));
    ...
    @Test
    public void shouldFailRSA256VerificationWhenUsingPrivateKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.dxXF3MdsyW-AuvwJpaQtrZ33fAde9xWxpLIg9cO2tMLH2GSRNuLAe61KsJusZhqZB9Iy7DvflcmRz-9OZndm6cj_ThGeJH2LLc90K83UEvvRPo8l85RrQb8PcanxCgIs2RcZOLygERizB3pr5icGkzR7R2y6zgNCjKJ5_NJ6EiZsGN6_nc2PRK_DbyY-Wn0QDxIxKoA5YgQJ9qafe7IN980pXvQv2Z62c3XR8dYuaXBqhthBj-AbaFHEpZapN-V-TmuLNzR2MCB6Xr7BYMuCaqWf_XU8og4XNe8f_8w9Wv5vvgqMM1KhqVpG5VdMJv4o_L4NoCROHhtUQSLRh2M9cA";
    ...
    public void shouldFailRSA384VerificationWhenProvidedPublicKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: SHA384withRSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Public Key is null.")));
    }

    @Test
    public void shouldFailRSA384VerificationWithInvalidPublicKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJSUzM4NCIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.TZlWjXObwGSQOiu2oMq8kiKz0_BR7bbBddNL6G8eZ_GoR82BXOZDqNrQr7lb_M-78XGBguWLWNIdYhzgxOUL9EoCJlrqVm9s9vo6G8T1sj1op-4TbjXZ61TwIvrJee9BvPLdKUJ9_fp1Js5kl6yXkst40Th8Auc5as4n49MLkipjpEhKDKaENKHpSubs1ripSz8SCQZSofeTM_EWVwSw7cpiM8Fy8jOPvWG8Xz4-e3ODFowvHVsDcONX_4FTMNbeRqDuHq2ZhCJnEfzcSJdrve_5VD5fM1LperBVslTrOxIgClOJ3RmM7-WnaizJrWP3D6Z9OLxPxLhM6-jx6tcxEw";
    ...
    @Test
    public void shouldFailRSA384VerificationWhenUsingPrivateKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJSUzM4NCIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.TZlWjXObwGSQOiu2oMq8kiKz0_BR7bbBddNL6G8eZ_GoR82BXOZDqNrQr7lb_M-78XGBguWLWNIdYhzgxOUL9EoCJlrqVm9s9vo6G8T1sj1op-4TbjXZ61TwIvrJee9BvPLdKUJ9_fp1Js5kl6yXkst40Th8Auc5as4n49MLkipjpEhKDKaENKHpSubs1ripSz8SCQZSofeTM_EWVwSw7cpiM8Fy8jOPvWG8Xz4-e3ODFowvHVsDcONX_4FTMNbeRqDuHq2ZhCJnEfzcSJdrve_5VD5fM1LperBVslTrOxIgClOJ3RmM7-WnaizJrWP3D6Z9OLxPxLhM6-jx6tcxEw";
    ...
    public void shouldFailRSA512VerificationWhenProvidedPublicKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature resulted invalid when verified using the Algorithm: SHA512withRSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Public Key is null.")));
    }

    @Test
    public void shouldFailRSA512VerificationWithInvalidPublicKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.mvL5LoMyIrWYjk5umEXZTmbyIrkbbcVPUkvdGZbu0qFBxGOf0nXP5PZBvPcOu084lvpwVox5n3VaD4iqzW-PsJyvKFgi5TnwmsbKchAp7JexQEsQOnTSGcfRqeUUiBZqRQdYsho71oAB3T4FnalDdFEpM-fztcZY9XqKyayqZLreTeBjqJm4jfOWH7KfGBHgZExQhe96NLq1UA9eUyQwdOA1Z0SgXe4Ja5PxZ6Fm37KnVDtDlNnY4JAAGFo6y74aGNnp_BKgpaVJCGFu1f1S5xCQ1HSvs8ZSdVWs5NgawW3wRd0kRt_GJ_Y3mIwiF4qUyHWGtsSHu_qjVdCTtbFyow";
    ...
    @Test
    public void shouldFailRSA512VerificationWhenUsingPrivateKey() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
            String jwt = "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.mvL5LoMyIrWYjk5umEXZTmbyIrkbbcVPUkvdGZbu0qFBxGOf0nXP5PZBvPcOu084lvpwVox5n3VaD4iqzW-PsJyvKFgi5TnwmsbKchAp7JexQEsQOnTSGcfRqeUUiBZqRQdYsho71oAB3T4FnalDdFEpM-fztcZY9XqKyayqZLreTeBjqJm4jfOWH7KfGBHgZExQhe96NLq1UA9eUyQwdOA1Z0SgXe4Ja5PxZ6Fm37KnVDtDlNnY4JAAGFo6y74aGNnp_BKgpaVJCGFu1f1S5xCQ1HSvs8ZSdVWs5NgawW3wRd0kRt_GJ_Y3mIwiF4qUyHWGtsSHu_qjVdCTtbFyow";
    ...
    @Test
    public void shouldThrowWhenMacAlgorithmDoesNotExists() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldThrowWhenThePublicKeyIsInvalid() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    @Test
    public void shouldThrowWhenTheSignatureIsNotPrepared() {
        Throwable exception = assertThrows(SignatureVerificationException.class, () -> {
    ...
    public void shouldFailOnRSA256SigningWhenProvidedPrivateKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: SHA256withRSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Private Key is null.")));
    }

    @Test
    public void shouldFailOnRSA256SigningWhenUsingPublicKey() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    public void shouldFailOnRSA384SigningWhenProvidedPrivateKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: SHA384withRSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Private Key is null.")));
    }

    @Test
    public void shouldFailOnRSA384SigningWhenUsingPublicKey() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
    ...
    public void shouldFailOnRSA512SigningWhenProvidedPrivateKeyIsNull() {
        ...
        assertThat(exception.getMessage(), containsString("The Token's Signature couldn't be generated when signing using the Algorithm: SHA512withRSA"));
        assertThat(exception.getCause(), isA(IllegalStateException.class));
        assertThat(exception.getCause().getMessage(), (is("The given Private Key is null.")));
    }

    @Test
    public void shouldFailOnRSA512SigningWhenUsingPublicKey() {
        Throwable exception = assertThrows(SignatureGenerationException.class, () -> {
